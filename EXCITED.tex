...
\end{align}
\noindent The expressions of the ADC MVP will be discussed in more detail in Chapter \ref{cha:AOADC}.
...
An alternative way for describing the molecular response to an external field using coupled cluster is via the equation-of-motion (EOM) ansatz \cite{Gee1989,EMr1981,Sta1993,Sta1994,Kry2008,Bar2011}. In the EOM approach, the target excited (R) and de-excited (L) wave functions are parameterized as 
\begin{align}
