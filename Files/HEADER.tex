...
\newcommand{\HFWFN}{\text{HF}}
\newcommand{\CIWFN}{\text{CI}}
\newcommand{\CCWFN}{\text{CC}}
...
\hyphenation{Al-ter-na-ti-ve-ly}
...
\hyphenation{cal-cu-la-tions}
\hyphenation{che-mis-try}
\hyphenation{co-lumn}
\hyphenation{co-lumns}
...
\hyphenation{ei-gen-func-tion}
\hyphenation{ei-gen-func-tions}
\hyphenation{ei-gen-vec-tor}
\hyphenation{ei-gen-vec-tors}
\hyphenation{e-le-ment}
\hyphenation{e-le-ments}
\hyphenation{e-ner-gies}
\hyphenation{ex-ploit}

\hyphenation{fac-to-ri-za-tion}
...
\hyphenation{Ü-ber-gangs-ma-tri-zen}
